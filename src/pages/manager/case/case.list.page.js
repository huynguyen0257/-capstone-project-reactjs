...
function DangerousCaseListPage() {
  ...
  const fetchDangerousCase = (renderLoading = true, params) => {
    ...
    return getDangerousCases(params).then((res) => {
          ...
          <div>
            ...
            >
              <Column
                ...
                render={(code, record) => (
                  <div>
                    ...
                    <div className={`ribbon ribbon-top-left ${historyStatusStates.filter(
              ...
              <Column
                ...
                align="center"
                render={(text, record) => (
                  <Tag  style={{ width: 160 }} color={`${record.PolicyColor}`}>{record.PolicyName}</Tag>
                )}
              />
